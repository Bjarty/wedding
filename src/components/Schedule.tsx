...
const events = [
  { time: '14:30', title: 'The Ceremony', loc: 'Villa La Vedetta Terrace', icon: Sparkles, desc: 'A sunset vow exchange overlooking the Duomo.' },
  { time: '16:00', title: 'Cocktail Hour', loc: 'The Rose Garden', icon: Utensils, desc: 'Italian Apertivo with classical strings quartet.' },
  { time: '18:30', title: 'Wedding Banquet', loc: 'The Grand Hall', icon: Utensils, desc: 'A five-course Tuscan culinary journey.' },
  { time: '21:00', title: 'First Dance & Party', loc: 'The Glass Pavilion', icon: Music, desc: 'Dancing under the stars to our favorite vinyls.' },
];

export default function Schedule() {
  return (
    <section id="schedule" className="py-32 bg-cream">
      <div className="max-w-5xl mx-auto px-6">
        <div className="text-center mb-24">
          ...
          <p className="font-accent italic text-2xl text-taupe">Saturday, September 12th</p>
        </div>
          ...
          {events.map((event, index) => (
            ...
            >
              <div className="w-full md:w-32 flex flex-col items-center md:items-end justify-center">
                ...
                <event.icon className="w-5 h-5 text-taupe mt-2 group-hover:scale-125 transition-transform" />
              </div>
              ...
              <div className="flex-1 card-glass p-10 md:p-12 rounded-[2rem] shadow-2xl group-hover:-translate-y-2 transition-all duration-500">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="bg-gold/10 p-2 rounded-xl">
                    <event.icon className="w-5 h-5 text-gold group-hover:rotate-12 transition-transform" />
                  </div>
                </div>
